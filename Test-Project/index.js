    ...
    */
    ...
    var clicked1 = false;
                    $('#id-div-container-1').on('mouseenter',function(){
                        if(clicked1 == false){
                        $('#id-div-container-1').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2').on('mouseenter',function(){
                        if(clicked2 == false){
                        $('#id-div-container-2').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3').on('mouseenter',function(){
                        if(clicked3 == false){
                        $('#id-div-container-3').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-4').on('mouseenter',function(){
                        if(clicked4 == false){
                        $('#id-div-container-4').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-5').on('mouseenter',function(){
                        if(clicked5 == false){
                        $('#id-div-container-5').css("border","6px solid Red");
                        }   
                    })
            ...
            /////////////////////
                    ...
                    $('#id-div-container-6').on('mouseenter',function(){
                        if(clicked6 == false){
                        $('#id-div-container-6').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-1').on('mouseenter',function(){
                        if(clicked7 == false){
                        $('#id-div-container-2-1').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-2').on('mouseenter',function(){
                        if(clicked8 == false){
                        $('#id-div-container-2-2').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-3').on('mouseenter',function(){
                        if(clicked9 == false){
                        $('#id-div-container-2-3').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-4').on('mouseenter',function(){
                        if(clicked10 == false){
                        $('#id-div-container-2-4').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-5').on('mouseenter',function(){
                        if(clicked11 == false){
                        $('#id-div-container-2-5').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-2-6').on('mouseenter',function(){
                        if(clicked12 == false){
                        $('#id-div-container-2-6').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-1').on('mouseenter',function(){
                        if(clicked13 == false){
                        $('#id-div-container-3-1').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-2').on('mouseenter',function(){
                        if(clicked14 == false){
                        $('#id-div-container-3-2').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-3').on('mouseenter',function(){
                        if(clicked15 == false){
                        $('#id-div-container-3-3').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-4').on('mouseenter',function(){
                        if(clicked16 == false){
                        $('#id-div-container-3-4').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-5').on('mouseenter',function(){
                        if(clicked17 == false){
                        $('#id-div-container-3-5').css("border","6px solid Red");
                        }   
                    })
                    ...
                    $('#id-div-container-3-6').on('mouseenter',function(){
                        if(clicked18 == false){
                        $('#id-div-container-3-6').css("border","6px solid Red");
                        }   
                    })
